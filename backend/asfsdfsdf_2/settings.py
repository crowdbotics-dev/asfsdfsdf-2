"""
Django settings for asfsdfsdf_2 project.
...
WSGI_APPLICATION = 'asfsdfsdf_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asfsdfsdf_2 API",
    "DESCRIPTION": "API documentation for asfsdfsdf_2 App",
    "VERSION": "v1",
}
